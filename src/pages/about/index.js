...
import aboutStaff1 from '../../assets/aboutStaff1.jpg'
          ...
          <Row>
            <Col span={24}>
              <div id='company' className={styles.introduction}>
                ...
                <p>长沙先导银象文化传媒有限公司是一家集品牌运营、新媒体运营、IP产业运营、大型活动组织为一体的新锐文化传媒企业，依托雄厚且丰富的资源优势，开展文化传媒全产业链业务。公司拥有优秀的运营、策划、设计、媒介与执行人才团队，以专业的品牌策划与运作能力为支撑，向客户提供前期策划、中期执行、后期维护的一站式服务。主营业务包括品牌策划与活动执行、广告资源整合运营、广告制作工程等。</p>
              </div>
            </Col>
          </Row>
          <Row>
